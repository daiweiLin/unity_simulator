...
def init(mode, num_visitors, unity_dir, save_dir, no_graphics=False, interact_with_app=True):
    ...
    if mode == 'SARA':
        # initialize ml agent
        agent = LASSpinUpTD3Agent('SpinUP PPO Agent', observation_dim=24, action_dim=168, num_observation=1,
